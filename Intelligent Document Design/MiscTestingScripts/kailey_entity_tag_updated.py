...
if __name__ == "__main__":
    ...
    entity_tag_to_find = entity_tag1  # Replace this with the actual tag you're looking for
    
    # Example usage: set index to None to use entity tag instead
    main(bucket_name, entity_tag_to_find, index=index_1)  # Or set index to an integer to use array index
