...
def get_s3_bucket_object(bucket, index=15):  # Change index to 15 for the 16th document
...
if __name__ == "__main__":
    ...
    object_key = get_s3_bucket_object(bucket_name, index=15)  # Change index to 15 for the 16th document
